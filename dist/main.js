...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(1).polyfill(); //eslint-disable-line
	__webpack_require__(4); //eslint-disable-line
	  ...
	  _createClass(Localizator, [{
	    ...
	    value: function load(source, callback) {
	      ...
	      if (source && typeof source === 'string' && callback && typeof callback === 'function') {
	        ...
	        fetch(this.source).then(function (rsp) {
	          if (rsp.status >= 400) {
	            throw new Error('Bad response from server');
	          }
	          return rsp.json();
	        }).then(function (rsp) {
	          _this.memorySource = rsp;
	          callback(_this.memorySource);
	        });
	      } else {
...
/***/ }
/******/ ]);
//# sourceMappingURL=main.js.map?8b89fff9c4bbf518860f